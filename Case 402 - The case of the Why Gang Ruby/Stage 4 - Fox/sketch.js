...
Officer: 1820440
CaseNum: 402-3-78563328-1820440
...
function draw()
{
	...
	if (det.locationY == 140)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
	if (det.locationX == 703)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
	if (det.locationY == 266)
	{
		det.speedX = -1;
		det.speedY = 0;
	}
	if (det.locationX == 250 && det.locationY == 266)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
	if (det.locationY == 456)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
	if (det.locationX == 838)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
	if (det.locationY == 582)
	{
		det.speedX = -1;
		det.speedY = 0;
	}
	if (det.locationX == 446 && det.locationY == 582)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
	if (det.locationY == 629)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
	if (det.locationX == 758 && det.locationY == 629)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
